...
from resources.s3_resources import S3Resource
...
async def handle_list_tools() -> list[Tool]:
    return [
        Tool(
            name="list_buckets", # https://docs.aws.amazon.com/AmazonS3/latest/API/API_ListBuckets.html
        ...
        Tool(
            name="list_objects", # https://docs.aws.amazon.com/AmazonS3/latest/API/API_ListObjectsV2.html
        ...
        Tool(
            name="get_object", # https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetObject.html
